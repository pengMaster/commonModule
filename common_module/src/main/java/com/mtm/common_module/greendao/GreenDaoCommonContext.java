 ...
 * @date 2017/11/24
 */
public class GreenDaoCommonContext extends ContextWrapper {

    private String currentUserId = "greendao";//一般用来针对一个用户一个数据库，以免数据混乱问题
    private Context mContext;

    public GreenDaoCommonContext() {
        super(InitApplicationContext.mAppContext);
        this.mContext = InitApplicationContext.mAppContext;
//        this.currentUserId = "greendao";//初始化
    ...
    public File getDatabasePath(String dbName) {
        String dbDir = ConstantUtils.getSchoolDbPath();
